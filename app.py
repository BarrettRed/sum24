...
def find_minimal_unique_subset(entities, attributes):
    ...
    for n in range(1, len(attribute_list) + 1):
        for subset in combinations(attribute_list, n):
            ...
            """
            Если максимально возможное количество уникальных значений
            всех признаков в подмножестве меньше, чем общее
            количество сущностей, то текущий набор признаков
            не может уникально идентифицировать все сущности.
            """
